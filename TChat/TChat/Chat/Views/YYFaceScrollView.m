...
- (void)initViews
{
    ...
    pageControl = [[UIPageControl alloc] initWithFrame:CGRectMake(0, scrollView.frame.origin.y+scrollView.frame.size.height, 40, 20)];
...
//    bottomView = [[UIView alloc] initWithFrame:CGRectMake(0, pageControl.bottom+10, 320, 35)];
    bottomView = [[UIView alloc] initWithFrame:CGRectMake(0, scrollView.frame.origin.y+scrollView.frame.size.height+20, kWidth, 35)];
    ...
    [smallemoBtn setImage:[UIImage bundleImageName:@"emotion"] forState:UIControlStateNormal];
...
{
    int pageNumber = _scrollView.contentOffset.x/kWidth;
