...
- (kxMovieError) openInput: (NSString *) path
{
    ...
    formatCtx->max_analyze_duration =1500;
    formatCtx->probesize=3056;
    ...
    @autoreleasepool {
        ...
        switch (level) {
            ...
            default:
                ...
                {
                    @try {
                           LoggerStream(3, @"%@---level=%d", [message stringByTrimmingCharactersInSet:[NSCharacterSet newlineCharacterSet]],level);
