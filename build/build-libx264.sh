...
CONFIGURE_FLAGS="--enable-static --enable-shared  --enable-pic --disable-cli"
...
# end: added by sunminmin, 2015/09/07
  ...
  do
    ...
    CC="xcrun -sdk $XCRUN_SDK clang -Wno-error=unused-command-line-argument -Wno-uninitialized -arch $ARCH "
