...
typealias alertInputHanld = (cont:String)->Void;
/**
 弹出一个按钮的 简单弹出框
 ...
 */
func showSimplpAlertView(uiCtrol:UIViewController?, tl:String,msg:String,btnHiht:String = "确定") -> Void {
...
func showLoginlert(uiCtrol:UIViewController?) -> UIAlertController {
